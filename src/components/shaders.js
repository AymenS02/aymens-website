...
void main() {
    ...
    if (length(iMouse.xy) > 0.0) {
        ...
        // Debug: Add visible effect around mouse
        float mouseDistance = length(U - mousePos);
        if (mouseDistance < 50.0) {
            me.xy += 0.05 * normalize(mousePos - U);
            me.z += 0.02;
        }
...
void main() {
    ...
    vec2 uv = (fragCoord * 2.0 - 2.0 - iResolution.xy) / mr;
